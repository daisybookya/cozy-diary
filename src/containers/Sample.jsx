    ...
    <Container>
      <div className="sub-container sample">
        ...
        <section className="part">
          ...
          <ul>
            <li>
              平常做事三分鐘熱度，常常半途而廢的人。本日記內容格式極簡，每天輕鬆練習紀錄內容，無形中培養紀錄習慣。
            </li>
            <li>
              粗心大意，常常忘東忘西的人。日記用途多廣，可以當作某些特定事項的日記，例如植物澆水紀錄．運動紀錄．繳費記錄等等。
            </li>
            <li>
              心志堅定．有上進心的人，希望利用日記達到目標。可以將日記當作未來日記使用，例如簡約的讀書計畫．目標導向存錢紀錄。
            </li>
            <li>
