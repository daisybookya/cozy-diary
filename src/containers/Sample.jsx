    ...
    <Container>
      <div className="sub-container sample">
        ...
        <section className="part">
          ...
          <ul>
            <li>
              平常做事三分鐘熱度，常常半途而廢，可以利用本日記內容格式極簡，每天輕鬆練習紀錄內容，無形中培養紀錄習慣。
            </li>
            <li>
              粗心大意，常常忘東忘西的朋友，可以將日記當作某些特定事項的日記，例如植物澆水紀錄．運動紀錄．繳費記錄等等。
            </li>
            <li>
              希望利用日記達到目標，可以當作未來日記使用，例如簡約的讀書計畫．目標導向存錢紀錄。
            </li>
            <li>
              希望人生充滿好運的人。透過書寫感恩日記，感恩的能量回流，將會為人生帶來好運！
            </li>
          </ul>
        </section>
        <section className="part">
          ...
          <ul>
            ...
            <li>
              ...
              <div className="sample-box">
                <figure>
                  <figcaption>幼稚園老師提醒要讓孩子少看電視與平板</figcaption>
                  盡量帶孩子去公園，或者多閱讀培養專注力
                </figure>
                <figure>
                  <figcaption>
